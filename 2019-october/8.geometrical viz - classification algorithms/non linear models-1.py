...
final_estimator = comutils.grid_search_best_model(dt_estimator, dt_grid, X_train, y_train)
...
final_estimator = comutils.grid_search_best_model(knn_estimator, knn_grid, X_train, y_train)
cutils.plot_model_2d_classification(final_estimator, X_train, y_train)

rf_estimator = ensemble.RandomForestClassifier()
rf_grid  = {'max_depth':list(range(5,10)), 'n_estimators':list(range(1,100, 20)) }
final_estimator = comutils.grid_search_best_model(rf_estimator, rf_grid, X_train, y_train)
cutils.plot_model_2d_classification(final_estimator, X_train, y_train)

et_estimator = ensemble.ExtraTreesClassifier()
et_grid  = {'max_depth':list(range(5,10)), 'n_estimators':list(range(1,100, 20)) }
final_estimator = comutils.grid_search_best_model(et_estimator, et_grid, X_train, y_train)
cutils.plot_model_2d_classification(final_estimator, X_train, y_train)
...
final_estimator = comutils.grid_search_best_model(ada_estimator, ada_grid, X_train, y_train)
cutils.plot_model_2d_classification(final_estimator, X_train, y_train)
...
final_estimator = comutils.grid_search_best_model(gb_estimator, gb_grid, X_train, y_train)
cutils.plot_model_2d_classification(final_estimator, X_train, y_train)
...
final_estimator = comutils.grid_search_best_model(xgb_estimator, xgb_grid, X_train, y_train)
cutils.plot_model_2d_classification(final_estimator, X_train, y_train)
