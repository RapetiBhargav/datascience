...
final_estimator = comutils.grid_search_best_model(perceptron_estimator, perceptron_grid, X_train, y_train)
...
final_estimator = comutils.grid_search_best_model(lr_estimator, lr_grid, X_train, y_train)
print(final_estimator.intercept_)
print(final_estimator.coef_)
cutils.plot_model_2d_classification(final_estimator, X_train, y_train)
...
final_estimator = comutils.grid_search_best_model(lsvm_estimator, lsvm_grid, X_train, y_train)
print(final_estimator.intercept_)
print(final_estimator.coef_)
cutils.plot_model_2d_classification(final_estimator, X_train, y_train)
